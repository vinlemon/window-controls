...
`;class mt extends nt{static styles=[gt,n`
      :host {
    ...
    `}}class vt extends nt{static styles=[gt,n`
      :host {
    ...
    `];static properties={inactive:{type:Boolean},minimize:{type:Function},maximize:{type:Function},close:{type:Function}};constructor(){super(),this.inactive=!1,this.minimize=()=>{},this.maximize=()=>{},this.close=()=>{}}render(){return j`
    ...
    `}}class $t extends nt{static styles=n`
    :host {
      position: absolute;
      top: 0;
      left: 0;
  ...
  `;static properties={os:{type:0},controls:{type:Object}};constructor(){super()}updated(t){t.has("controls")&&this._propagateControls()}_propagateControls(){const t=this.shadowRoot.querySelector(`${this.os}-controls`);t&&Object.assign(t,this.controls)}_getControlsTemplate(){switch(this.os){case"macos":return j`<macos-controls></macos-controls>`;case"windows":return j`<windows-controls></windows-controls>`;case"linux":return j`<gnome-controls></gnome-controls>`;default:return null}}render(){return this._getControlsTemplate()}}class bt extends nt{static styles=[gt,n`
      :host {
    ...
    `}}window.customElements.define("window-controls",$t),window.customElements.define("windows-controls",bt),window.customElements.define("macos-controls",vt),window.customElements.define("gnome-controls",mt),st(j`
          <table>
            <tr>
              <th>Component</th>
              <th>Preview</th>
