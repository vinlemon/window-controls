...
`;class gt extends rt{static styles=[mt,r`
      :host {
    ...
    `}}class $t extends rt{static styles=[mt,r`
      :host {
    ...
    `}}class vt extends rt{static styles=r`
    :host {
      position: absolute;
      top: 0;
      left: 0;
  ...
  `;static properties={os:{type:0},controls:{type:Object}};constructor(){super()}_getControlsTemplate(){switch(this.os){case"macos":return j`<macos-controls
        ...
        ></windows-controls>`;case"linux":return j`<gnome-controls
          ...
          .maximize=${this.controls.maximize}
          .close=${this.controls.close}
        ></gnome-controls>`;default:return null}}render(){return this._getControlsTemplate()}}class bt extends rt{static styles=[mt,r`
      :host {
